...
public class Transferencia {
    ...
    public Transferencia(Jogador jogador, Time timeOrigem, Time timeDestino, double multaRescisoria, double luvas, double valor, LocalDate data, double comissaoAgente) {
        if (jogador == null) throw new IllegalArgumentException("Jogador não pode ser nulo na transferência.");
        if (timeDestino == null) throw new IllegalArgumentException("Time de destino não pode ser nulo na transferência.");
        if (data == null) throw new IllegalArgumentException("Data da transferência não pode ser nula.");
    ...
    public Time getTimeOrigem() { return timeOrigem; }
    public void setTimeOrigem(Time timeOrigem) { this.timeOrigem = timeOrigem; }
    public Time getTimeDestino() { return timeDestino; }
    public void setTimeDestino(Time timeDestino) { this.timeDestino = timeDestino; }
